...
/**
 * Template Method base class for visual path-finder tests.
 * Provides a standard lifecycle (init, compute, visualize) with
 * {@code System.nanoTime()} timing at each phase.
 *
 * <p>Subclasses override {@link #createPathFinder()} and set up
 * {@code env / start / goal / visualizer} before calling
 * {@link #initAndComputePath()}.
 *
...
public abstract class AbstractVisualPathFinderTest<P extends Point> {
	...
	/**
	 * Runs phases 1-2 of the test lifecycle:
	 *   1) Create & initialize the algorithm (timed)
	 *   2) Compute the initial path (timed + visualized)
	 * Returns the computed path for further assertions or visual walking.
	 */
