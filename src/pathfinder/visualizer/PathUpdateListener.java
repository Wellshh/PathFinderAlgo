...
/**
 * Observer callback from the algorithm layer to the UI layer.
 * Implementations should marshal UI updates to the appropriate thread
 * (e.g. {@code Platform.runLater()} for JavaFX).
 *
