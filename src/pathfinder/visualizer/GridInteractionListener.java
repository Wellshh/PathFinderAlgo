...
/**
 * Observer callback from the UI layer to the algorithm layer.
 * Fired by mouse/keyboard interaction on the visualizer canvas.
 * Implementations typically dispatch work to a background thread.
 */
