...
/**
 * Concrete 2D grid implementation of {@link Environment} for testing. Supports 8-directional
 * movement with configurable cell costs. Obstacle cells have cost {@code Double.POSITIVE_INFINITY}.
 */
public class Grid2DEnvironment implements Environment<Point2D> {
  ...
  /**
   * Per-cell traversal weight. A value of {@code Double.POSITIVE_INFINITY} means the cell is
   * blocked (obstacle). The edge cost from A to B equals {@code cellCost[B.y][B.x] *
   * distance(A,B)}.
   */
