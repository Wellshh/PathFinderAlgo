...
/**
 * Test-purpose sensor that compares a "ground truth" grid against the
 * algorithm's "known" grid, returning {@link EdgeUpdate}s for all edges
 * within a configurable sensing radius whose costs differ.
 */
public class SimpleGridSensor implements IEnvironmentSensor<Point2D> {
	 ...
	 */
	public SimpleGridSensor(Grid2DEnvironment groundTruth,
			Grid2DEnvironment knownMap,
			int senseRadius) {
