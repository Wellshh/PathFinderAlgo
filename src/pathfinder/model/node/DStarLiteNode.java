...
public class DStarLiteNode<P extends Point> extends BaseNode<P> implements Comparable<DStarLiteNode<P>> {
	/**
	...
	public double getKtop() { return this.kTop; }

	public void setKtop(double val) { this.kTop = val; }

	public double getKbot() { return this.kBottom; }

	public void setKbot(double val) { this.kBottom = val; }

	/** Constant variable for comparison between Doubles */
	private static final double EPSILON = 1e-5;

	public DStarLiteNode(P pos) { super(pos); }
